    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative">
                <img class="img-fluid rounded w-150 wow zoomIn" src="img/Images/login.jpg" style="width: 720px; height: 720px;">
                <!--begin::Wrapper-->
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    <!--begin::Content-->
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                        <!--begin::Logo-->
                        <a href="/home" class="py-9 mb-5">
                            <img alt="Logo" src="{{ asset('img/logo/logo.png') }}" class="h-100px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        <h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color:white;">Welcome to DineEase</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <p class="fw-bold fs-2" style="color: white;">Savor the taste,
                            <br />embrace the feast</p>
                        <!--end::Description-->
                    </div>
                    <!--end::Content-->
                    <!--begin::Illustration-->
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="/login" method="POST">
                            ...
                            <div class="text-center mb-10">
                                <!--begin::Title-->
                                <h1 class="text-dark mb-3">Sign In to DineEase</h1>
                                <!--end::Title-->
                                <!--begin::Link-->
...
{{--                                    <img alt="Logo" src="{{ asset('guest_assets/media/svg/brand-logos/google-icon.svg') }}" class="h-20px me-3" />Continue with Google</a>--}}
                                <!--end::Google link-->
                            </div>
                            <!--end::Actions-->
                        </form>
...
@section('script')
    ...
    <script src="{{ asset('guest_assets/js/custom/authentication/sign-in/general.js') }}"></script>
