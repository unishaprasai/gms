            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="{{url('frontend/img/classes/class-1.jpg')}}" alt="">
                        </div>
                        <div class="ci-text">
                            <span>STRENGTH</span>
                            <h5>Weightlifting</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="{{url('frontend/img/classes/class-2.jpg')}}" alt="">
                        </div>
                        <div class="ci-text">
                            <span>Cardio</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="{{url('frontend/img/classes/class-3.jpg')}}" alt="">
                        </div>
                        <div class="ci-text">
                            <span>STRENGTH</span>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="{{url('frontend/img/classes/class-4.jpg')}}" alt="">
                        </div>
                        <div class="ci-text">
                            <span>Cardio</span>
                ...
                <div class="col-lg-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="{{url('frontend/img/classes/class-5.jpg')}}" alt="">
                        </div>
                        <div class="ci-text">
                            <span>Training</span>
                            <h4>Boxing</h4>
