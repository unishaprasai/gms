                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('update_member/' . $members->id) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="address" name="maddress"
                                    value="{{ $members->address }}" required>
                            </div>
                            <div class="form-group">
                                <label for="phone">Phone Number</label>
                                <input type="tel" class="form-control" id="phone" name="mphone"
                                    value="{{ $members->phone }}" required>
                            </div>
                            <div class="form-group">
                                <label for="date_of_join">Date of Joining</label>
                                <input type="date" class="form-control" id="date_of_join" name="date_of_join"
                                    value="{{ $members->date_of_join }}" required>
                            </div>
                            <div class="form-group">
